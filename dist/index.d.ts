...
declare class YTMusic {
     ...
     * @returns Lyrics
     */
    getTimedLyrics(videoId: string): Promise<string>;
    /**
...
// @ts-ignore
export = YTMusic;
export { AlbumBasic, AlbumDetailed, AlbumFull, ArtistBasic, ArtistDetailed, ArtistFull, HomeSection, PlaylistDetailed, PlaylistFull, SearchResult, SongDetailed, SongFull, ThumbnailFull, VideoDetailed, VideoFull };
